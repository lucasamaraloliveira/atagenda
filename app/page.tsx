    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 md:p-6">
        <motion.div 
          ...
          className="w-full max-w-[400px] bg-white rounded-[2rem] shadow-2xl shadow-indigo-100/50 border border-slate-100 overflow-hidden"
        >
          <div className="p-8 md:p-10 text-center bg-indigo-600 text-white relative overflow-hidden">
            {/* Decorative circles */}
            <div className="absolute -top-10 -right-10 w-32 h-32 bg-white/10 rounded-full blur-2xl" />
            <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-indigo-400/20 rounded-full blur-2xl" />
            
            <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-md border border-white/30 relative z-10">
              <Lock size={32} />
            </div>
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight relative z-10">ATAgenda</h1>
            <p className="text-indigo-100 text-xs md:text-sm mt-2 relative z-10 opacity-90">Acesse sua conta para continuar</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="p-8 md:p-10 space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <input 
                  ...
                  className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all"
            ...
            <div className="flex items-center justify-between px-1">
              ...
              <button type="button" className="text-[11px] font-bold text-indigo-600 hover:text-indigo-700 transition-colors">Esqueceu a senha?</button>
            </div>
